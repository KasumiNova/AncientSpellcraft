...
public class WarlockElementalSpellEffects {
	...
	public static Map<Element, int[]> PARTICLE_COLOURS = ImmutableMap.<Element, int[]>builder()
			...
			.put(Element.ICE, new int[]{0xfafeff, 0xebfcff, 0xb5f4ff, 0xffffff})
			.put(Element.LIGHTNING, new int[]{0xffffff, 0x2f3d52, 0x225474, 0xffffff})
			.put(Element.NECROMANCY, new int[]{0x56096b, 0x540154, 0x382366, 0xffffff})
