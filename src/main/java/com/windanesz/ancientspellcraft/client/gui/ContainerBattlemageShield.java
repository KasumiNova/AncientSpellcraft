...
public class ContainerBattlemageShield extends Container {
	private final IInventory itemInventory;

	public ContainerBattlemageShield(IInventory playerInventory, IInventory itemInventory, EntityPlayer player) {
